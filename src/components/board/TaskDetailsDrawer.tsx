      ...
      <div className="space-y-6 text-slate-200">
        ...
        <div>
          ...
          <Input
            ...
            className="text-base font-semibold bg-[#161619]"
          />
        </div>
        ...
        <div>
          ...
          <textarea
            ...
            className="w-full rounded-2xl bg-[#161619] p-3.5 text-sm text-white placeholder:text-neutral-500 focus:outline-none focus:ring-2 focus:ring-white/30 transition-all resize-none shadow-xs"
          />
        </div>
        ...
        <div className="space-y-4 pt-4 border-t border-white/5">
          ...
          <form onSubmit={handleAddComment} className="flex gap-2">
            <input
              ...
              className="flex-1 rounded-xl bg-[#161619] px-3.5 py-2 text-xs text-white placeholder:text-neutral-500 focus:outline-none focus:ring-2 focus:ring-white/30 shadow-xs"
            />
            <Button
              type="submit"
              variant="primary"
              ...
              className="bg-white hover:bg-neutral-100 active:bg-neutral-200 text-black font-bold rounded-xl"
            >
              Post
            </Button>
          </form>
            ...
            {taskComments.length === 0 ? (
              ...
              taskComments.map((comment) => {
                ...
                return (
                  <div
                    key={comment.id}
                    className="p-3.5 rounded-2xl bg-[#161619] shadow-xs space-y-1.5"
                  >
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-2">
                        {author?.avatar ? (
                          ...
                          <div className="h-5 w-5 rounded-full bg-white text-black text-[10px] flex items-center justify-center font-bold">
                            {author?.name[0] || 'U'}
                          </div>
                        )}
